% This script predicts the soot index(TSI)using artificial neural network 
% 10 features of the input  and one output are loaded and the network is
%  trained to generate a suitable prediction model 
% The Authors:
% 1. Mohammed Ameen Ahmed Qasem 2.Vincent C.O. van Oudenhoven  
% 3. Abdul Gani Abdul Jameel    4.Eid Al Mutairi, 
% 5. Amjad A. Pasha     6. S. Nadaraja Pillai ,
% 7. V. Mahendra Reddy  8. Usama Ahmed    9. Shaikh A. Razzak a
